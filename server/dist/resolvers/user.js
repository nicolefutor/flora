...
let UserResolver = class UserResolver {
    ...
    changePassword(token, newPassword, { redis, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log('searched for redis key with ', constants_1.FORGET_PASSWORD_PREFIX + token);
            if (!userId) {
                return {
                    errors: [
                        {
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log('st redis key with ', constants_1.FORGET_PASSWORD_PREFIX + token, user.id);
